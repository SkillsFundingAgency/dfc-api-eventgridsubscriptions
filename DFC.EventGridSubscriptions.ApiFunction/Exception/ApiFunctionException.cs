...
namespace DFC.EventGridSubscriptions.ApiFunction
{
    ...
    public class ApiFunctionException : Exception
    {
        ...
        public ApiFunctionException(string message) : base(message)
        {
        }

        public ApiFunctionException(string message, Exception innerException) : base(message, innerException)
        {
        }
